...
import PreferredSourcesDrawer from './components/PreferredSourcesDrawer';
              ...
              <div className="flex-1 overflow-y-auto p-6 flex flex-col gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <Link to="/search" onClick={() => setIsMobileMenuOpen(false)} className="w-full flex items-center gap-4 p-3 rounded-xl hover:bg-white/5 text-white/80 hover:text-white transition-colors text-sm text-left">
                    ...
                    <span>
                      ...
                      <span className="block text-[11px] text-nexus-muted mt-0.5">Find exactly what you're looking for</span>
                    </span>
                  </Link>
                </div>
                ...
                {user && (
                  <>
                    ...
                    <div className="space-y-2">
                      ...
                      <button onClick={() => { setIsThemeDrawerOpen(true); setIsMobileMenuOpen(false); }} className="w-full flex items-center gap-4 p-3 rounded-xl hover:bg-white/5 text-white/80 hover:text-white transition-colors text-sm text-left">
                      ...
                      <button onClick={() => { setIsFandomsDrawerOpen(true); setIsMobileMenuOpen(false); }} className="w-full flex items-center gap-4 p-3 rounded-xl hover:bg-white/5 text-white/80 hover:text-white transition-colors text-sm text-left">
                      ...
                      <button onClick={() => { setIsSourcesDrawerOpen(true); setIsMobileMenuOpen(false); }} className="w-full flex items-center gap-4 p-3 rounded-xl hover:bg-white/5 text-white/80 hover:text-white transition-colors text-sm text-left">
                        <Compass className="w-5 h-5 text-accent/70 shrink-0" />
                        <span>
                    ...
                    <div className="space-y-2">
                      ...
                      <button onClick={() => { setIsHistoryDrawerOpen(true); setIsMobileMenuOpen(false); }} className="w-full flex items-center gap-4 p-3 rounded-xl hover:bg-white/5 text-white/80 hover:text-white transition-colors text-sm text-left">
                ...
                {!user && (
                  <>
                    <div className="w-12 h-[1px] bg-white/5 my-2"></div>
                    <div className="space-y-2">
                      <p className="text-xs font-semibold text-nexus-muted uppercase tracking-widest mb-4">Account</p>
                      <button onClick={() => { signInWithGoogle(); setIsMobileMenuOpen(false); }} className="w-full flex items-center gap-4 p-3 rounded-xl hover:bg-white/5 text-white/80 hover:text-white transition-colors text-sm text-left">
                        <LogIn className="w-5 h-5 text-accent/70 shrink-0" />
                        <span>
                          <span className="block font-medium">Sign In</span>
                          <span className="block text-[11px] text-nexus-muted mt-0.5">Sync your preferences and history</span>
                        </span>
                      </button>
                    </div>
                  </>
          ...
          <div className="fixed inset-0 z-[100] flex justify-end">
            ...
            >
              ...
              <div className="flex-1 overflow-y-auto p-6 flex flex-col gap-6">
                ...
                <div className="space-y-2">
                  <p className="text-xs font-semibold text-nexus-muted uppercase tracking-widest mb-4">Preferences</p>
                  <button onClick={() => { setIsThemeDrawerOpen(true); setIsUserMenuOpen(false); }} className="w-full flex items-center gap-4 p-3 rounded-xl hover:bg-white/5 text-white/80 hover:text-white transition-colors text-sm text-left">
                    <Settings className="w-5 h-5 text-accent/70 shrink-0" />
                    <span>
                      <span className="block font-medium">Theme & Display</span>
                      <span className="block text-[11px] text-nexus-muted mt-0.5">Sophisticated Dark, Typography</span>
                  ...
                  <button onClick={() => { setIsSourcesDrawerOpen(true); setIsUserMenuOpen(false); }} className="w-full flex items-center gap-4 p-3 rounded-xl hover:bg-white/5 text-white/80 hover:text-white transition-colors text-sm text-left">
                    <Compass className="w-5 h-5 text-accent/70 shrink-0" />
                    <span>
                      <span className="block font-medium">Preferred Sources</span>
                      <span className="block text-[11px] text-nexus-muted mt-0.5">AO3, Spacebattles, FF.net</span>
                ...
                <div className="space-y-2">
                  <p className="text-xs font-semibold text-nexus-muted uppercase tracking-widest mb-4">Library</p>
                  <button onClick={() => { setIsHistoryDrawerOpen(true); setIsUserMenuOpen(false); }} className="w-full flex items-center gap-4 p-3 rounded-xl hover:bg-white/5 text-white/80 hover:text-white transition-colors text-sm text-left">
                    <BookOpen className="w-5 h-5 text-nexus-muted shrink-0" /> Reading History
                  </button>
                </div>
              </div>
